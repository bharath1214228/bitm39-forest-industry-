...
var acceptedState = "accepted", revokedState = "revoked", CookieControl = function () {
    var e = {
        ...
        i = ["branding", "excludedCountries", "locales"], r = {
            ...
            removeIcon: !1,
            removeAbout: !1
        }, c = document.body, d = document.createElement("section");
    ...
    function h(r) {
        ...
        // if (null != r && r.product && e[r.product.toUpperCase()]) {
            ...
            var p = "https://apis.aubergine262.com/civiccookiecontrol.php?d=" + encodeURIComponent(document.location.hostname) + "&p=" + encodeURIComponent(e[r.product.toUpperCase()]) + "&v=8&k=" + encodeURIComponent(r.apiKey) + "&format=json";
                ...
                200 === g.status ? (a = "API VERIFICATION PASSED", function (r, a) {
                    if (function (i, r) {
                            if (i && t.product.toLowerCase() !== e.COMMUNITY.toLowerCase()) {
                                var a = t.geo.countryName, l = t.geo.country;
                                if ("" === l || "" === a) return !1;
                    ...
                    if (r.product.toLowerCase() === e.COMMUNITY.toLowerCase()) for (var l = 0; l < i.length; l++) a[i[l]] && (console.warn("Cookie Control: Users with a community license cannot use the " + i[l] + " option."), delete a[i[l]]);
                    b(a)
    ...
    function b(o) {
        ...
        for (var i = 0; i < n.length; i++) if ("object" == typeof o[n[i]] && !1 === Array.isArray(o[n[i]])) {
        ...
        !function (o) {
            ...
            if (null != o.locales && t.product.toLowerCase() !== e.COMMUNITY.toLowerCase()) {
                var b = window.navigator.userLanguage || window.navigator.language,
                    m = (b = b.replace("-", "_")).substring(0, 2), k = o.locales.filter(function (e) {
            ...
            if (function (e) {
                ...
                }(h), p.optionalCookies.innerHTML = "", null != o.optionalCookies && o.optionalCookies.length > 0) for (var x = 0; x < o.optionalCookies.length; x++) {
                var w = o.optionalCookies[x], I = document.createElement("div"),
                ...
                var A = I.querySelector("input"), O = I.querySelector(".toggle");
    ...
    function x(e) {
        var t = k(), o = Object.keys(t);
        if (!0 === e) for (var n = 0; n < o.length; n++) C(o[n]); else {
            for (var i = [], r = 0; r < y.necessaryCookies.length; r++) {
                i = w(y.necessaryCookies[r], o, i)
            }
            if (null != y.optionalCookies) for (var a = 0; a < y.optionalCookies.length; a++) {
                var l = y.optionalCookies[a];
                if (v(l.name) || S(l.name) && T(l)) for (var s in i.push(l.name), l.cookies) i = w(l.cookies[s], o, i)
            }
    ...
    function w(e, t, o) {
        if (e.lastIndexOf("*") == e.length - 1) for (var n = e.slice(0, -1), i = 0; i < t.length; i++) 0 == t[i].indexOf(n) && o.push(t[i]); else o.push(e);
        return o
    }
    ...
    function I(e) {
        ...
        if (v(n.name) || T(n) && S(n.name)) localStorage.setItem("ccc-" + n.name, revokedState), C(n.name), x(), null != n.thirdPartyCookies && function (e) {
            ...
            for (var n = 0; n < t.thirdPartyCookies.length; n++) {
                var i = t.thirdPartyCookies[n], r = document.createElement("a");
        ...
        }(e), null != n.onRevoke && n.onRevoke(), d.querySelector('.toggle[data-index="' + e + '"]').style.left = "4px"; else {
            ...
            for (var i = 0, r = location.hostname.split("."), a = n.name + "=accepted;path=/;"; i < r.length && !1 === v(n.name);) {
                ...
                var l = new Date, s = new Date(l.setDate(l.getDate() + y.consentCookieExpiry));
